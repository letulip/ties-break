...
export interface PendingView {
   ...
   *  other builders of this view pass null by construction – the College League and the Nations Cup
   *  are not tour weeks and the big-stage licence never reaches them.
   *
