...
import { isExamWeek, isOffSeasonWeek, TIERS, TIER_SHORT } from './season/calendar'
...
import { tierFromEventId, lastKidResultOf, lastKidTitleOf, milestoneKey, MEMORY_EMOTION, DiaryWorldView, conditionBandOf, fundsPressureOf } from './diary/facts'
