...
function toldSnapshot(band: BondBand, seed = 'met-card'): Snapshot {
  ...
  world.loveEpisodes = [{ id: 'p:890', sinceWeek: 890, endedWeek: null, knownWeek: 900, wants: 'open', partnerId: 'p:890', publicWeek: null, publicWrong: false, airedMetWeek: null, airedEndedWeek: null, latchedWeek: null, partnerName: null }]
