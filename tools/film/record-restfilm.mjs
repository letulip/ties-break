...
const OUT = process.argv[2] || '/tmp/restfilm'
...
step('goto rig')
await page.goto(`${URL}/tools/film/rest-film.html`, { waitUntil: 'networkidle' })
...
console.log('seed', report.seed, '| entry', report.conditionAtEntry, '-> after', report.conditionAfterMatch, '| resort', report.afterResort, '| light', report.afterLight)
