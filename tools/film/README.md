...
potential. `Math.random` is pinned at exactly 0.5 for the life of each phone document, so both land
on the middle of their range – `prologue-i0000` and `alice-i000` – and both halves are the same girl.
