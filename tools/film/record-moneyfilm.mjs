// Film SHE WON - AND WE STILL LOST MONEY. The rig plays its own timeline (with its own 300ms crossfades) and the
...
const OUT = process.argv[2] || '/tmp/moneyfilm'
...
step('goto rig')
await page.goto(`${URL}/tools/film/money-film.html`, { waitUntil: 'networkidle' })
...
console.log('seed', report.seed, '| net', report.net, '| points', report.points, '| final', report.rounds[4].score)
