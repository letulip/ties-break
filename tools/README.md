...
241 TypeScript files: **40 live**, **201 archival**.
...
- `band-probe.ts` · `band-vs-field.ts` · `best16-bench.ts` · `big-draw-cost.ts`
- `big-rung-finishes.ts` · `big-rung-odds.ts` · `birthday-age-read.ts` · `birthday-pool.ts`
- `boredom-guard.ts` · `brand-dynamics.ts` · `brand-gate-bench.ts` · `calendar-shape.ts`
...
- `empty-week-census.ts` · `failure-modes.ts` · `fatigue-ledger-diag.ts` · `feed-audit.ts`
- `field-quality.ts` · `fifth-skill-probe.ts` · `first-pair-replay.ts` · `first-ranking-probe.ts`
- `fork-birthday-probe.ts` · `grid-visibility.ts` · `growth-age-sweep.ts` · `growth-pace-probe.ts`
...
- `ladder-walk.ts` · `live-table-inflation.ts` · `load-and-injury.ts` · `market-probe.ts`
...
- `population-depth.ts` · `potential-band-sweep.ts` · `pressure-set-census.ts` · `preview-drift.ts`
- `pro-season-probe.ts` · `r29-item14-anger.ts` · `r29-item14-read.ts` · `r29p2-savings-sweep.ts`
