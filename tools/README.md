...
266 TypeScript files: **55 live**, **211 archival**.
...
- `_corridor.ts` · `_reveals.ts` · `_seeds.ts` · `acceptance-cuts.ts`
- `aer-cohort.ts` · `age-clock-cost.ts` · `age-composition.ts` · `age-gate-shift.ts`
- `age-injury-fit.ts` · `album-money-probe.ts` · `album-spread-probe.ts` · `alice-story-read.ts`
...
- `cancel-share-bench.ts` · `career-vs-bench.ts` · `ceiling-walk.ts` · `clone-bench.ts`
...
- `college-scene-bench.ts` · `college-talent-bands.ts` · `college-year-content.ts` · `commentary-register-probe.ts`
...
- `draw-vs-band.ts` · `drought-probe.ts` · `empty-week-census.ts` · `fade-read.ts`
- `failure-modes.ts` · `fatigue-ledger-diag.ts` · `feed-audit.ts` · `field-quality.ts`
- `fifth-skill-probe.ts` · `first-pair-replay.ts` · `first-ranking-probe.ts` · `fork-birthday-probe.ts`
...
- `motherhood-bench.ts` · `nation-depth.ts` · `next-goal-bench.ts` · `odds-calibration.ts`
- `one-clock.ts` · `opener-price-bench.ts` · `outcome-odds.ts` · `pause-brand-probe.ts`
...
- `preview-drift.ts` · `pro-season-probe.ts` · `probe-favorite-curve.ts` · `r29-item14-anger.ts`
...
- `r42-sparring-price.ts` · `r42-team-budget-cap.ts` · `reach-sweep.ts` · `real-vs-bench.ts`
...
- `season-anchor-read.ts` · `seed-vs-model.ts` · `skill-gap-odds.ts` · `slam-difficulty.ts`
- `slam-door-cost.ts` · `sponsor-cadence.ts` · `sponsor-ladder-reach.ts` · `sponsor-silence-probe.ts`
