...
234 TypeScript files: **39 live**, **195 archival**.
...
- `r41-winrate-2036.ts` · `r42-coach-every-cheque.ts` · `r42-composure-bonus.ts` · `r42-kid-share-ramp.ts`
- `r42-personality-read.ts` · `r42-team-budget-cap.ts` · `reach-sweep.ts` · `real-vs-bench.ts`
