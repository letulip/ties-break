...
192 TypeScript files: **31 live**, **161 archival**.
...
- `r35-draw-fact.ts` · `r38-academy-worth.ts` · `r38-decline-cliff.ts` · `r38-decline-shape.ts`
- `r38-fame-presence-sweep.ts` · `r38-field-read.ts` · `r38-save-read.ts` · `reach-sweep.ts`
