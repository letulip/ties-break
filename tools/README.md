...
144 TypeScript files: **24 live**, **120 archival**.
...
- `college-choice-probe.ts` · `college-fork.ts` · `college-freeze-probe.ts` · `college-news-probe.ts`
...
- `draw-vs-band.ts` · `empty-week-census.ts` · `failure-modes.ts` · `fatigue-ledger-diag.ts`
- `feed-audit.ts` · `field-quality.ts` · `fifth-skill-probe.ts` · `first-ranking-probe.ts`
- `fork-birthday-probe.ts` · `grid-visibility.ts` · `growth-age-sweep.ts` · `head-ladder-sweep.ts`
...
- `live-table-inflation.ts` · `load-and-injury.ts` · `masseur-bench.ts` · `match-clock-probe.ts`
...
- `pro-season-probe.ts` · `reach-sweep.ts` · `real-vs-bench.ts` · `rehab-lever.ts`
- `restore-bench.ts` · `rival-fatigue-audit.ts` · `round15-read.ts` · `round16-read.ts`
