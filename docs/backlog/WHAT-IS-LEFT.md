...
- [the-private-life-build.md](../plans/the-private-life-build.md) – steps 1–4 with numbers, seams, schema moves and benches; steps 5–8 sized as sketches. ⚙ **STEP 1 IS BUILT (09.09, wave 1)**: `spirit`, `bond` and `temperament` ship behind schema v72, with the match seam, the Mood word, the bond bands and her first quoted voice – see [the runbook](../plans/wave-1-the-two-numbers-runbook-2026-09.md) and [who-she-is §4a](../specs/who-she-is-2026-09.md) for what the bench measured. Steps 2–4 are unbuilt, so the row stays **Next, L** · five owner questions still open in its §8 (two of the seven were ruled on 23.08) · [the-private-life-layer.md](the-private-life-layer.md)
