...
| R2-16 = E1's design (derived preference, parent responds) | 13-response | ⚙ **SHIPPED 09.09, wave 2** – the derived preference is her fork want, the parent's response is the beat's three options, and both deltas land on `bond` | M | **Done** |
