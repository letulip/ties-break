...
| `CollegeYearCard` calls a NEGATIVE `fundsDeltaCents` «Banked» – PROD-11's other half; a signed label or two labels, the owner's word. Re-verified 24.08: `<dt>Banked</dt>` over `formatCents(lastYear.fundsDeltaCents)`, unguarded by sign | `CollegeYearCard.vue:331` + [13-response](../review-codex/13-full-project-review-response-2026-08-23.md) | his ruling – XS | **Next** |
