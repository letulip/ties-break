...
| # | the question | where the argument lives | since |
| --- | --- | --- | --- |
| 1 | **The Slam's literal label.** The professional rungs were renamed to fictional `World Tour N` on 19.08 (round 22), which closed most of the trademark flag – but the top tier's label is still the sport's own term, and the invariant says fictional. Rename or accept, one word either way. | [round-22.md](../rounds/round-22.md) foot, item 5; the `slam` block in [calendar.ts](../../src/engine/season/calendar.ts) | 18.08 |
