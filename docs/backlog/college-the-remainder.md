...
| # | what remains | where it is specified | blocked by | size | state |
| --- | --- | --- | --- | --- | --- |
| 1 | **The re-entry screen** – she returns after four years to a field the conveyor has turned over, and nothing says so. Named the branch's strongest next candidate (22.08). | [college-as-a-place.md](../plans/college-as-a-place.md) §7e | nothing – buildable now | M | Next |
| 2 | **The open controls inside the freeze** – four command sites still refuse and await a ruling each: hire/fire the coach, book a vacation (three collision weeks now), buy a racquet, training plan/physio. (The birthday gift was the fifth; resolved 22.08.) | [college-as-a-place.md](../plans/college-as-a-place.md) §6b (the table) | an owner ruling per row | S each | Next |
| 3 | **Between-year decisions** – the year card carries the rubbers and the birthday, but §7c-orig's remaining candidates (does she play the summer, what she studies, does the family keep paying for anything) are still the honest gap. | [college-as-a-place.md](../plans/college-as-a-place.md) §2, §7c-orig | design – needs the owner to pick which decisions are real | M | Next |
| 4 | **The portrait ages** – ⚠ an ART ORDER, not a build task: builders may not create or derive art. Decide how many ages exist, commission the assets; the wiring is trivial after. Same family as round 3's «5 стадий по арту». | [college-as-a-place.md](../plans/college-as-a-place.md) §6; [round-3-qa.md](../rounds/round-3-qa.md) | the owner commissions art | L (art), S (wiring) | Next |
...
| 7 | **Her opinion at the fork (E1)** – «где-то её мнение увидеть» – ⚙ **SHIPPED 09.09 in wave 2**, and it did NOT grow a second opinion system – which is what the pause was protecting. Her want rides the private life's own beat machinery (`lifeLog`, the `'life'` stop, one dialog), and the fork simply refuses to be answered until she has been. [wave-2 runbook](../plans/wave-2-the-reaction-surface-runbook-2026-09.md) §3. | [college-the-flow.md](../plans/college-the-flow.md) E1 + ruling 4 | – | S | **Done** |
