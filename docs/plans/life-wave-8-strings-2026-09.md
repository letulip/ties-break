...
| ---: | --- | --- | --- | --- |
| P1 | `lifeBeat.ts` · `EXPECTING_HER_LINE.sunny.roof` | the `'expecting'` card while she lives under the roof, bond `close`/`steady`, voice `sunny` | ~~She waited until we were all sitting down, and then said it straight out. "We are having a baby. I am happy and I am frightened, and I wanted you to know both."~~ → **She waited until we were all sitting down, and then said it straight out. "We are having a baby. I have barely sat on it. I am happy and I am frightened, and I wanted you to know both."** | ⚠ `SUPERSEDED 22.09 by wave 11 T3` – her quoted span gained one clause carrying the hidden window (the design's §4 column 1 read into column 2). THE NARRATION DID NOT MOVE A BYTE – it is what the PARENT saw, and he cannot see a window he was never inside. Still `DRAFT – awaiting his pass` |
| P2 | `EXPECTING_HER_LINE.sunny.away` | the same card from college/independence – the call frame | ~~She called on a Sunday, before anything else had been said. "We are having a baby. I am happy and I am frightened, and I wanted you to know both."~~ → **She called on a Sunday, before anything else had been said. "We are having a baby. I have barely sat on it. I am happy and I am frightened, and I wanted you to know both."** | ⚠ `SUPERSEDED 22.09 by wave 11 T3` – her quoted span gained one clause carrying the hidden window (the design's §4 column 1 read into column 2). THE NARRATION DID NOT MOVE A BYTE – it is what the PARENT saw, and he cannot see a window he was never inside. Still `DRAFT – awaiting his pass` |
| P3 | `EXPECTING_HER_LINE.fiery.roof` | as P1, voice `fiery` | ~~She came in and said it before her coat was off. "We are having a baby. I have thought about the tennis. I am not finished."~~ → **She came in and said it before her coat was off. "We are having a baby. I did not wait to be sure. I have thought about the tennis. I am not finished."** | ⚠ `SUPERSEDED 22.09 by wave 11 T3` – her quoted span gained one clause carrying the hidden window (the design's §4 column 1 read into column 2). THE NARRATION DID NOT MOVE A BYTE – it is what the PARENT saw, and he cannot see a window he was never inside. Still `DRAFT – awaiting his pass` |
| P4 | `EXPECTING_HER_LINE.fiery.away` | as P2, voice `fiery` | ~~She rang between flights and led with it. "We are having a baby. I have thought about the tennis. I am not finished."~~ → **She rang between flights and led with it. "We are having a baby. I did not wait to be sure. I have thought about the tennis. I am not finished."** | ⚠ `SUPERSEDED 22.09 by wave 11 T3` – her quoted span gained one clause carrying the hidden window (the design's §4 column 1 read into column 2). THE NARRATION DID NOT MOVE A BYTE – it is what the PARENT saw, and he cannot see a window he was never inside. Still `DRAFT – awaiting his pass` |
| P5 | `EXPECTING_HER_LINE.quiet.roof` | as P1, voice `quiet` | ~~She mentioned it while she was looking at the calendar, as if it were a fixture change. "We are having a baby. I will play a while yet, and then I will not."~~ → **She mentioned it while she was looking at the calendar, as if it were a fixture change. "We are having a baby. I have known a while. I will play a while yet, and then I will not."** | ⚠ `SUPERSEDED 22.09 by wave 11 T3` – her quoted span gained one clause carrying the hidden window (the design's §4 column 1 read into column 2). THE NARRATION DID NOT MOVE A BYTE – it is what the PARENT saw, and he cannot see a window he was never inside. Still `DRAFT – awaiting his pass` |
| P6 | `EXPECTING_HER_LINE.quiet.away` | as P2, voice `quiet` | ~~She sent the next block of dates through, and this was underneath them. "We are having a baby. I will play a while yet, and then I will not."~~ → **She sent the next block of dates through, and this was underneath them. "We are having a baby. I have known a while. I will play a while yet, and then I will not."** | ⚠ `SUPERSEDED 22.09 by wave 11 T3` – her quoted span gained one clause carrying the hidden window (the design's §4 column 1 read into column 2). THE NARRATION DID NOT MOVE A BYTE – it is what the PARENT saw, and he cannot see a window he was never inside. Still `DRAFT – awaiting his pass` |
| P7 | `EXPECTING_HER_LINE.deep.roof` | as P1, voice `deep` | ~~She sat with it through most of the evening, and then put it in one sentence. "We are having a baby. I know what it costs. I want it."~~ → **She sat with it through most of the evening, and then put it in one sentence. "We are having a baby. I have known a long time, and I needed to know what I felt about it first. I know what it costs. I want it."** | ⚠ `SUPERSEDED 22.09 by wave 11 T3` – her quoted span gained one clause carrying the hidden window (the design's §4 column 1 read into column 2). THE NARRATION DID NOT MOVE A BYTE – it is what the PARENT saw, and he cannot see a window he was never inside. Still `DRAFT – awaiting his pass` |
| P8 | `EXPECTING_HER_LINE.deep.away` | as P2, voice `deep` | ~~She was quiet for most of the call, and said it just before goodbye. "We are having a baby. I know what it costs. I want it."~~ → **She was quiet for most of the call, and said it just before goodbye. "We are having a baby. I have known a long time, and I needed to know what I felt about it first. I know what it costs. I want it."** | ⚠ `SUPERSEDED 22.09 by wave 11 T3` – her quoted span gained one clause carrying the hidden window (the design's §4 column 1 read into column 2). THE NARRATION DID NOT MOVE A BYTE – it is what the PARENT saw, and he cannot see a window he was never inside. Still `DRAFT – awaiting his pass` |
...
| P13 | `LIFE_BEAT_OPTIONS.expecting[2]` (`career-first`) | the third button (−4, `support: 'cold'`) | ~~Ask her what this does to the tennis~~ → **Say it is too early – look where she is** | ⚠ `SUPERSEDED 22.09 by wave 11 T3` – the design's §5 asked for the reasonable position («not now, look where you are») rather than a question about the tennis. THE GRADE DID NOT MOVE (−4, `support: 'cold'`). Still `DRAFT – awaiting his pass` |
...
| P16 | `ANSWER_EVENT.expecting['career-first']` | the same row after `career-first` | ~~She is expecting a child. We asked what it does to the tennis.~~ → **She is expecting a child. We said it was too early.** | ⚠ `SUPERSEDED 22.09 by wave 11 T3` – moved WITH P13, because this row's job is to say what the parent said. Still `DRAFT – awaiting his pass` |
