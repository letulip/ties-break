...
- [~] **12.** (heading reconstructed 09.09 – destroyed by a paste collision; the opening of his
  quote is lost – its surviving tail:) **«…
...
- [x] **14a. «„She said it in the car. Three seasons on the professional table and it has not moved…"
  ...
  **OWNER (08.09): «интересный механизм, давай только подумаем когда его реально включать, потому
  ...
  → built in round 40 (wave-c), see round-40.md (ticked 09.09).

- [x] **14b. «И как-то надо подсветить, когда она сама дальше вообще не готова играть продолжать.
