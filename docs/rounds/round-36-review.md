...
## Second pass – five items from the stand (05.09.2026)

He looked at the built review wave on the local stand (`round/36` at `98e3560b`, 1280 wide) and
came back with five more. Same numbering discipline: his words, then the reading. Prefixed `P2-`
so they cannot be confused with the eighteen above.

- [x] **P2-1. «артефакты в верстке всех страниц магазина»** – build. The screenshot shows a
  paragraph of English prose under «On the water» that ends in `–›`. Reading: the HTML comment at
  `src/components/screens/MoneyScreen.vue:2369-2378` quotes the literal `<!-- -->` inside itself,
...
- [x] **P2-2. «сетка на главной на десктоп не исправлена (см. мои правки предыдущие, мне нужно
...
- [x] **P2-3. «давай на главной десктопе текущую дату всю вынесем в 2 строки и поставим справа от
...
- [x] **P2-4. «если колокольчик, письмо и шестеренка только на главной работают - давай их вернем
...
- [x] **P2-5. «на week results картинку крупнее на 50% ширины контейнера с ней и кропаем немного,
...
- [x] **P2-6. «и аватар с текущей позицией и рангом (так же, как и все остальные плашки) на десктоп
