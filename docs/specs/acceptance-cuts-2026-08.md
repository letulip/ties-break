...
| `w75.minAgeYears` **17** | ✅ **ANSWERED 16.08 – he took it. Now 14** | Reality's floor is **14**, not 17, and the one rung-specific rule is a *quota* (3 W75+ events inside a 14-year-old's 8), not a door. ⚠ **And on this rung the age gate is doing the acceptance list's job** – §3a, and it still is after the correction (§4b). A real change and a large one: it would put a fourteen-year-old on the professional tour. ⭐ **He read this row and ruled**: «настоящих порогов только два – 14 и 18». Measured, it moved W75's median first entry 18.0 → 17.9 – §3a was right that the cut, not the door, was the gate. Grid, stated once: [`college-is-its-own-branch-2026-08.md` §0a](college-is-its-own-branch-2026-08.md) |
