...
- Her last played event stays inside the first trimester by construction (`playsOnWeeks: 8` reads
  from the announcement as shipped; the window only moves knowledge, not the calendar of play).
