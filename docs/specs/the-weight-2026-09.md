...
| --- | --- | --- | --- |
| 1 | bereavement frequency over the 23→35 tail, switch on | ~40% of careers meet one, ~8% a second; spacing ≥156 and cap 2 never violated | ⭐ **THE REVIEW'S `--corpus 200` RUN (23.09): 31.0% met one, 8.5% a second, 0 violations.** A walked career lives a mean **573** of the 624 tail weeks, whose closed form is 1−e^(−573·0.0008) ≈ **36.7%** – so 31.0 sits 1.7 SEM under it at n=200: within honest sampling noise, and the second-loss share lands ON his ~8%. **His 0.08%/week STANDS untouched.** (The builder's first fill at n=60 – 25.0/10.0, 1.6 SEM – asked for exactly this run before anybody tuned; it was right to.) |
